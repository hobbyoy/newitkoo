...
export default function MobileSidebarMenu() {
  ...
  return (
    <>
      ...
      {/* 💻 데스크탑 상단바 네비게이션 */}
      <div className="hidden lg:flex w-full fixed top-0 left-0 z-40 bg-white/50 backdrop-blur-xl border-b border-white/30 shadow-lg px-6 h-[64px] items-center justify-center gap-4">
        {visibleTabs.map(tab => (
          <Link
            key={tab.path}
            href={tab.path}
